...
ETH_PRIVATE_KEY=ugf awfihqwoid132b1231b23
...
POLYGON_MUMBAI_PROVIDER_URL=wss://polygon-mainnet
POLYGON_MUMBAI_ENCRYPTION_MNEMONIC=never gonna tell a lie and hurt you
```
